      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.cardDetails}>
          ...
          <Text style={styles.cardDescription}>
            ...
            virtual. A nossa saudade continua grande por aqui. Por isso,
            convidamos você para participar do nosso próximo Café com
            Colaboradores que será no dia 8 de abril, das 8h30 às 10h.
            Continuaremos no formato virtual.
          </Text>
          <Text style={styles.cardDescription}>
          ...
          <Text style={styles.cardDescription}>
            Para participar, increva-se em{' '}
            <Text style={styles.textEvents}>Eventos</Text>, na Portonet, até
            19/3. Os sorteados receberão o convite por e-mail em 24/3, já com
            o link para a participação no encontro.
          </Text>
          <Text style={styles.cardDescription}>Capriche no café!</Text>
        </View>
      </SafeAreaView>
    </>
  );
